...
=======
        ...
        public GameView(Court court, Pane root, double scale, SceneHandler sceneHandler, int nbreracket,boolean[]AI,boolean SystemdeVie) {
                super(court, root, scale, sceneHandler);
...
=======
                ...
                getRoot().getChildren().addAll(ball,lifePlayerLeft,lifePlayerR, commande[0], commande[1], commande[2], commande[3], commande[4],commande[5],commande[6],commande[7],commande[8],commande[9],commande[10],score); // On ajoute le score aux éléments du Pane
