...
public class WinView extends View {
    ...
    public WinView(Court court, Pane root, double scale, SceneHandler sceneHandler, String joueur, boolean[] AI, int n,
            boolean small, boolean medium, boolean large, boolean SystemdeVie) {
        ...
        this.again.setOnAction(event -> {
            AudioBank.button.play();
            sceneHandler.switchToGame(getRoot(), n, small, medium, large, AI, SystemdeVie);
        });
